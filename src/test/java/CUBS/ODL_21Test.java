...
public class ODL_21Test extends TestCase{
	...
	@Test
	public void testODL_21(){
		String mutantName = "ODL_21";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_21.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_21.BillCalculation();
