...
public class COI_5Test extends TestCase{
	...
	@Test
	public void testCOI_5(){
		String mutantName = "COI_5";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COI_5.BillCalculation mutant = new labprograms.CUBS.mutants.COI_5.BillCalculation();
