...
public class LOI_10Test extends TestCase{
	...
	@Test
	public void testLOI_10(){
		String mutantName = "LOI_10";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.LOI_10.BillCalculation mutant = new labprograms.CUBS.mutants.LOI_10.BillCalculation();
