...
public class ODL_25Test extends TestCase{
	...
	@Test
	public void testODL_25(){
		String mutantName = "ODL_25";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_25.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_25.BillCalculation();
