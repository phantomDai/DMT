...
public class ODL_26Test extends TestCase{
	...
	@Test
	public void testODL_26(){
		String mutantName = "ODL_26";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_26.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_26.BillCalculation();
