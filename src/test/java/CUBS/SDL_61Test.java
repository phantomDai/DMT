...
public class SDL_61Test extends TestCase{
	...
	@Test
	public void testSDL_61(){
		String mutantName = "SDL_61";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_61.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_61.BillCalculation();
