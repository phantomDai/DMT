...
public class AORB_23Test extends TestCase{
	...
	@Test
	public void testAORB_23(){
		String mutantName = "AORB_23";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.AORB_23.BillCalculation mutant = new labprograms.CUBS.mutants.AORB_23.BillCalculation();
