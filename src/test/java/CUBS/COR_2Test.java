...
public class COR_2Test extends TestCase{
	...
	public void testCOR_2(){
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COR_2.BillCalculation mutant = new labprograms.CUBS.mutants.COR_2.BillCalculation();
