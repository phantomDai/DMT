...
public class AORB_24Test extends TestCase{
	...
	@Test
	public void testAORB_24(){
		String mutantName = "AORB_24";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.AORB_24.BillCalculation mutant = new labprograms.CUBS.mutants.AORB_24.BillCalculation();
