...
public class SDL_55Test extends TestCase{
	...
	@Test
	public void testSDL_55(){
		String mutantName = "SDL_55";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_55.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_55.BillCalculation();
