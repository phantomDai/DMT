...
public class ODL_18Test extends TestCase{
	...
	@Test
	public void testODL_18(){
		String mutantName = "ODL_18";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_18.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_18.BillCalculation();
