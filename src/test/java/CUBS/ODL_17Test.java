...
public class ODL_17Test extends TestCase{
	...
	@Test
	public void testODL_17(){
		String mutantName = "ODL_17";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_17.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_17.BillCalculation();
