...
public class LOI_7Test extends TestCase{
	...
	@Test
	public void testLOI_7(){
		String mutantName = "LOI_7";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.LOI_7.BillCalculation mutant = new labprograms.CUBS.mutants.LOI_7.BillCalculation();
