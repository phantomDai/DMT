...
public class SDL_50Test extends TestCase{
	...
	@Test
	public void testSDL_50(){
		String mutantName = "SDL_50";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_50.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_50.BillCalculation();
