...
public class COI_7Test extends TestCase{
	...
	@Test
	public void testCOI_7(){
		String mutantName = "COI_7";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COI_7.BillCalculation mutant = new labprograms.CUBS.mutants.COI_7.BillCalculation();
