...
public class COI_6Test extends TestCase{
	...
	@Test
	public void testCOI_6(){
		String mutantName = "COI_6";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COI_6.BillCalculation mutant = new labprograms.CUBS.mutants.COI_6.BillCalculation();
