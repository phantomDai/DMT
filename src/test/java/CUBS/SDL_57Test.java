...
public class SDL_57Test extends TestCase{
	...
	@Test
	public void testSDL_57(){
		String mutantName = "SDL_57";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_57.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_57.BillCalculation();
