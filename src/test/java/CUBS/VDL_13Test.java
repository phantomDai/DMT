...
public class VDL_13Test extends TestCase{
	...
	@Test
	public void testVDL_13(){
		String mutantName = "VDL_13";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.VDL_13.BillCalculation mutant = new labprograms.CUBS.mutants.VDL_13.BillCalculation();
