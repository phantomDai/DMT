...
public class VDL_9Test extends TestCase{
	...
	@Test
	public void testVDL_9(){
		String mutantName = "VDL_9";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.VDL_9.BillCalculation mutant = new labprograms.CUBS.mutants.VDL_9.BillCalculation();
