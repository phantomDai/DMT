...
public class VDL_11Test extends TestCase{
	...
	@Test
	public void testVDL_11(){
		String mutantName = "VDL_11";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.VDL_11.BillCalculation mutant = new labprograms.CUBS.mutants.VDL_11.BillCalculation();
