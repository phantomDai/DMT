...
public class ODL_27Test extends TestCase{
	...
	@Test
	public void testODL_27(){
		String mutantName = "ODL_27";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_27.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_27.BillCalculation();
