...
public class SDL_60Test extends TestCase{
	...
	@Test
	public void testSDL_60(){
		String mutantName = "SDL_60";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_60.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_60.BillCalculation();
