...
public class VDL_10Test extends TestCase{
	...
	@Test
	public void testVDL_10(){
		String mutantName = "VDL_10";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.VDL_10.BillCalculation mutant = new labprograms.CUBS.mutants.VDL_10.BillCalculation();
