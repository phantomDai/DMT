...
public class LOI_9Test extends TestCase{
	...
	@Test
	public void testLOI_9(){
		String mutantName = "LOI_9";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.LOI_9.BillCalculation mutant = new labprograms.CUBS.mutants.LOI_9.BillCalculation();
