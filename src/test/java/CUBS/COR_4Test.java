...
public class COR_4Test extends TestCase{
	...
	@Test
	public void testCOR_4(){
		String mutantName = "COR_4";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COR_4.BillCalculation mutant = new labprograms.CUBS.mutants.COR_4.BillCalculation();
