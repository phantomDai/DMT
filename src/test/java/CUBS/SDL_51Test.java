...
public class SDL_51Test extends TestCase{
	...
	@Test
	public void testSDL_51(){
		String mutantName = "SDL_51";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_51.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_51.BillCalculation();
