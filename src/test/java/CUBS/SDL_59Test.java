...
public class SDL_59Test extends TestCase{
	...
	@Test
	public void testSDL_59(){
		String mutantName = "SDL_59";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_59.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_59.BillCalculation();
