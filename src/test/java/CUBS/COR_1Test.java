...
public class COR_1Test extends TestCase{
	...
	public void testCOR_1(){
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COR_1.BillCalculation mutant = new labprograms.CUBS.mutants.COR_1.BillCalculation();
