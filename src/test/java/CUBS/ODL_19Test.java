...
public class ODL_19Test extends TestCase{
	...
	@Test
	public void testODL_19(){
		String mutantName = "ODL_19";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_19.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_19.BillCalculation();
