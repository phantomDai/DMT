...
public class SDL_52Test extends TestCase{
	...
	@Test
	public void testSDL_52(){
		String mutantName = "SDL_52";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_52.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_52.BillCalculation();
