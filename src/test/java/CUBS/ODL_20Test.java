...
public class ODL_20Test extends TestCase{
	...
	@Test
	public void testODL_20(){
		String mutantName = "ODL_20";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_20.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_20.BillCalculation();
