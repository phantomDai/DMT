...
public class VDL_12Test extends TestCase{
	...
	@Test
	public void testVDL_12(){
		String mutantName = "VDL_12";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.VDL_12.BillCalculation mutant = new labprograms.CUBS.mutants.VDL_12.BillCalculation();
