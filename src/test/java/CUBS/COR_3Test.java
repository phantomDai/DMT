...
public class COR_3Test extends TestCase{
	...
	public void testCOR_3(){
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COR_3.BillCalculation mutant = new labprograms.CUBS.mutants.COR_3.BillCalculation();
