...
public class LOI_12Test extends TestCase{
	...
	@Test
	public void testLOI_12(){
		String mutantName = "LOI_12";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.LOI_12.BillCalculation mutant = new labprograms.CUBS.mutants.LOI_12.BillCalculation();
