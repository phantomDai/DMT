...
public class ODL_5Test extends TestCase{
	...
	@Test
	public void testODL_5(){
		String mutantName = "ODL_5";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_5.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_5.BillCalculation();
