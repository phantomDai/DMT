...
public class VDL_15Test extends TestCase{
	...
	@Test
	public void testVDL_15(){
		String mutantName = "VDL_15";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.VDL_15.BillCalculation mutant = new labprograms.CUBS.mutants.VDL_15.BillCalculation();
