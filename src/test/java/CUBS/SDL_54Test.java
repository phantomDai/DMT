...
public class SDL_54Test extends TestCase{
	...
	@Test
	public void testSDL_54(){
		String mutantName = "SDL_54";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_54.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_54.BillCalculation();
