...
public class AORB_22Test extends TestCase{
	...
	@Test
	public void testAORB_22(){
		String mutantName = "AORB_22";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.AORB_22.BillCalculation mutant = new labprograms.CUBS.mutants.AORB_22.BillCalculation();
