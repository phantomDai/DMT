...
public class ODL_22Test extends TestCase{
	...
	@Test
	public void testODL_22(){
		String mutantName = "ODL_22";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_22.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_22.BillCalculation();
