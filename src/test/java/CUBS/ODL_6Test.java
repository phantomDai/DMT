...
public class ODL_6Test extends TestCase{
	...
	@Test
	public void testODL_6(){
		String mutantName = "ODL_6";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_6.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_6.BillCalculation();
