...
public class ODL_23Test extends TestCase{
	...
	@Test
	public void testODL_23(){
		String mutantName = "ODL_23";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_23.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_23.BillCalculation();
