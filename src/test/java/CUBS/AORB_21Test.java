...
public class AORB_21Test extends TestCase{
	...
	@Test
	public void testAORB_21(){
		String mutantName = "AORB_21";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.AORB_21.BillCalculation mutant = new labprograms.CUBS.mutants.AORB_21.BillCalculation();
