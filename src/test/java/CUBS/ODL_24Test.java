...
public class ODL_24Test extends TestCase{
	...
	@Test
	public void testODL_24(){
		String mutantName = "ODL_24";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_24.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_24.BillCalculation();
