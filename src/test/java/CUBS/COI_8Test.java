...
public class COI_8Test extends TestCase{
	...
	@Test
	public void testCOI_8(){
		String mutantName = "COI_8";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.COI_8.BillCalculation mutant = new labprograms.CUBS.mutants.COI_8.BillCalculation();
