...
public class LOI_8Test extends TestCase{
	...
	@Test
	public void testLOI_8(){
		String mutantName = "LOI_8";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.LOI_8.BillCalculation mutant = new labprograms.CUBS.mutants.LOI_8.BillCalculation();
