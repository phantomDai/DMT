...
public class VDL_14Test extends TestCase{
	...
	@Test
	public void testVDL_14(){
		String mutantName = "VDL_14";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.VDL_14.BillCalculation mutant = new labprograms.CUBS.mutants.VDL_14.BillCalculation();
