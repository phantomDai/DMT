...
public class SDL_56Test extends TestCase{
	...
	@Test
	public void testSDL_56(){
		String mutantName = "SDL_56";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_56.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_56.BillCalculation();
