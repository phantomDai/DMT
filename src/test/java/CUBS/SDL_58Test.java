...
public class SDL_58Test extends TestCase{
	...
	@Test
	public void testSDL_58(){
		String mutantName = "SDL_58";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.SDL_58.BillCalculation mutant = new labprograms.CUBS.mutants.SDL_58.BillCalculation();
