...
public class ODL_28Test extends TestCase{
	...
	@Test
	public void testODL_28(){
		String mutantName = "ODL_28";
		...
		for (TestCase4CUBS tc : testcases) {
			...
			labprograms.CUBS.mutants.ODL_28.BillCalculation mutant = new labprograms.CUBS.mutants.ODL_28.BillCalculation();
