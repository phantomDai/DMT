...
public class AOIS_48Test extends TestCase{
	...
	@Test
	public void testAOIS_48(){
		String mutantName = "AOIS_48";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_48.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_48.AirlinesBaggageBillingService();
