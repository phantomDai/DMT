...
public class AOIU_4Test extends TestCase{
	...
	@Test
	public void testAOIU_4(){
		String mutantName = "AOIU_4";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_4.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_4.AirlinesBaggageBillingService();
