...
public class VDL_6Test extends TestCase{
	...
	@Test
	public void testVDL_6(){
		String mutantName = "VDL_6";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.VDL_6.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.VDL_6.AirlinesBaggageBillingService();
