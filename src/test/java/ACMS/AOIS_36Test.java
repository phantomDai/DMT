...
public class AOIS_36Test extends TestCase{
	...
	@Test
	public void testAOIS_36(){
		String mutantName = "AOIS_36";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_36.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_36.AirlinesBaggageBillingService();
