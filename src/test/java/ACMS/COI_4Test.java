...
public class COI_4Test extends TestCase{
	...
	@Test
	public void testCOI_4(){
		String mutantName = "COI_4";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.COI_4.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.COI_4.AirlinesBaggageBillingService();
