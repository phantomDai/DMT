...
public class AOIS_31Test extends TestCase{
	...
	@Test
	public void testAOIS_31(){
		String mutantName = "AOIS_31";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_31.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_31.AirlinesBaggageBillingService();
