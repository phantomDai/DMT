...
public class COI_1Test extends TestCase{
	...
	@Test
	public void testCOI_1(){
		String mutantName = "COI_1";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.COI_1.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.COI_1.AirlinesBaggageBillingService();
