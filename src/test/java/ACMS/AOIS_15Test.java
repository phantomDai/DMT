...
public class AOIS_15Test extends TestCase{
	...
	@Test
	public void testAOIS_15(){
		String mutantName = "AOIS_15";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_15.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_15.AirlinesBaggageBillingService();
