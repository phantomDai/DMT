...
public class AOIS_51Test extends TestCase{
	...
	@Test
	public void testAOIS_51(){
		String mutantName = "AOIS_51";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_51.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_51.AirlinesBaggageBillingService();
