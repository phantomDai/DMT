...
public class AOIS_3Test extends TestCase{
	...
	@Test
	public void testAOIS_3(){
		String mutantName = "AOIS_3";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_3.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_3.AirlinesBaggageBillingService();
