...
public class AORB_9Test extends TestCase{
	...
	@Test
	public void testAORB_9(){
		String mutantName = "AORB_9";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_9.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_9.AirlinesBaggageBillingService();
