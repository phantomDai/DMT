...
public class SDL_6Test extends TestCase{
	...
	@Test
	public void testSDL_6(){
		String mutantName = "SDL_6";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_6.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_6.AirlinesBaggageBillingService();
