...
public class AOIS_46Test extends TestCase{
	...
	@Test
	public void testAOIS_46(){
		String mutantName = "AOIS_46";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_46.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_46.AirlinesBaggageBillingService();
