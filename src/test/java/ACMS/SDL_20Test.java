...
public class SDL_20Test extends TestCase{
	...
	@Test
	public void testSDL_20(){
		String mutantName = "SDL_20";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_20.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_20.AirlinesBaggageBillingService();
