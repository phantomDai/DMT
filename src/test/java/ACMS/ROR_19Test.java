...
public class ROR_19Test extends TestCase{
	...
	@Test
	public void testROR_19(){
		String mutantName = "ROR_19";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.ROR_19.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.ROR_19.AirlinesBaggageBillingService();
