...
public class ROR_18Test extends TestCase{
	...
	@Test
	public void testROR_18(){
		String mutantName = "ROR_18";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.ROR_18.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.ROR_18.AirlinesBaggageBillingService();
