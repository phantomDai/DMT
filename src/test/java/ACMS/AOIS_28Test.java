...
public class AOIS_28Test extends TestCase{
	...
	@Test
	public void testAOIS_28(){
		String mutantName = "AOIS_28";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_28.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_28.AirlinesBaggageBillingService();
