...
public class AOIS_21Test extends TestCase{
	...
	@Test
	public void testAOIS_21(){
		String mutantName = "AOIS_21";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_21.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_21.AirlinesBaggageBillingService();
