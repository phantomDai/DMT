...
public class AOIU_3Test extends TestCase{
	...
	@Test
	public void testAOIU_3(){
		String mutantName = "AOIU_3";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_3.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_3.AirlinesBaggageBillingService();
