...
public class AOIS_52Test extends TestCase{
	...
	@Test
	public void testAOIS_52(){
		String mutantName = "AOIS_52";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_52.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_52.AirlinesBaggageBillingService();
