...
public class LOI_14Test extends TestCase{
	...
	@Test
	public void testLOI_14(){
		String mutantName = "LOI_14";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_14.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_14.AirlinesBaggageBillingService();
