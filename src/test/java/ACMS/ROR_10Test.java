...
public class ROR_10Test extends TestCase{
	...
	@Test
	public void testROR_10(){
		String mutantName = "ROR_10";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.ROR_10.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.ROR_10.AirlinesBaggageBillingService();
