...
public class AOIS_4Test extends TestCase{
	...
	@Test
	public void testAOIS_4(){
		String mutantName = "AOIS_4";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_4.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_4.AirlinesBaggageBillingService();
