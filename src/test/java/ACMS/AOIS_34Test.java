...
public class AOIS_34Test extends TestCase{
	...
	@Test
	public void testAOIS_34(){
		String mutantName = "AOIS_34";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_34.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_34.AirlinesBaggageBillingService();
