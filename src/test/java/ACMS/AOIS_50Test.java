...
public class AOIS_50Test extends TestCase{
	...
	@Test
	public void testAOIS_50(){
		String mutantName = "AOIS_50";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_50.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_50.AirlinesBaggageBillingService();
