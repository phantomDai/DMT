...
public class AOIS_7Test extends TestCase{
	...
	@Test
	public void testAOIS_7(){
		String mutantName = "AOIS_7";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_7.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_7.AirlinesBaggageBillingService();
