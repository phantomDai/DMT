...
public class LOI_16Test extends TestCase{
	...
	@Test
	public void testLOI_16(){
		String mutantName = "LOI_16";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_16.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_16.AirlinesBaggageBillingService();
