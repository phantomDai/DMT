...
public class LOI_6Test extends TestCase{
	...
	@Test
	public void testLOI_6(){
		String mutantName = "LOI_6";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_6.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_6.AirlinesBaggageBillingService();
