...
public class AOIS_1Test extends TestCase{
	...
	@Test
	public void testAOIS_1(){
		String mutantName = "AOIS_1";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_1.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_1.AirlinesBaggageBillingService();
