...
public class SDL_32Test extends TestCase{
	...
	@Test
	public void testSDL_32(){
		String mutantName = "SDL_32";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_32.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_32.AirlinesBaggageBillingService();
