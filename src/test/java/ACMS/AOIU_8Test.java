...
public class AOIU_8Test extends TestCase{
	...
	@Test
	public void testAOIU_8(){
		String mutantName = "AOIU_8";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_8.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_8.AirlinesBaggageBillingService();
