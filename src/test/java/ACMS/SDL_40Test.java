...
public class SDL_40Test extends TestCase{
	...
	@Test
	public void testSDL_40(){
		String mutantName = "SDL_40";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_40.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_40.AirlinesBaggageBillingService();
