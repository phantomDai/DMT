...
public class AOIS_24Test extends TestCase{
	...
	@Test
	public void testAOIS_24(){
		String mutantName = "AOIS_24";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_24.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_24.AirlinesBaggageBillingService();
