...
public class LOI_5Test extends TestCase{
	...
	@Test
	public void testLOI_5(){
		String mutantName = "LOI_5";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_5.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_5.AirlinesBaggageBillingService();
