...
public class AOIS_27Test extends TestCase{
	...
	@Test
	public void testAOIS_27(){
		String mutantName = "AOIS_27";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_27.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_27.AirlinesBaggageBillingService();
