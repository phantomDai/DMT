...
public class AOIU_1Test extends TestCase{
	...
	@Test
	public void testAOIU_1(){
		String mutantName = "AOIU_1";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_1.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_1.AirlinesBaggageBillingService();
