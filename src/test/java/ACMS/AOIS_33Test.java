...
public class AOIS_33Test extends TestCase{
	...
	@Test
	public void testAOIS_33(){
		String mutantName = "AOIS_33";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_33.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_33.AirlinesBaggageBillingService();
