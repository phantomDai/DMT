...
public class AORB_18Test extends TestCase{
	...
	@Test
	public void testAORB_18(){
		String mutantName = "AORB_18";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_18.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_18.AirlinesBaggageBillingService();
