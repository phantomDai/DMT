...
public class SDL_48Test extends TestCase{
	...
	@Test
	public void testSDL_48(){
		String mutantName = "SDL_48";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_48.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_48.AirlinesBaggageBillingService();
