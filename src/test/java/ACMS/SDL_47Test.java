...
public class SDL_47Test extends TestCase{
	...
	@Test
	public void testSDL_47(){
		String mutantName = "SDL_47";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_47.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_47.AirlinesBaggageBillingService();
