...
public class AOIS_26Test extends TestCase{
	...
	@Test
	public void testAOIS_26(){
		String mutantName = "AOIS_26";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_26.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_26.AirlinesBaggageBillingService();
