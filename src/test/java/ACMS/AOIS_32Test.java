...
public class AOIS_32Test extends TestCase{
	...
	@Test
	public void testAOIS_32(){
		String mutantName = "AOIS_32";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_32.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_32.AirlinesBaggageBillingService();
