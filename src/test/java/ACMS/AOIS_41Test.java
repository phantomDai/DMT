...
public class AOIS_41Test extends TestCase{
	...
	@Test
	public void testAOIS_41(){
		String mutantName = "AOIS_41";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_41.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_41.AirlinesBaggageBillingService();
