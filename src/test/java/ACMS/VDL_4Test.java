...
public class VDL_4Test extends TestCase{
	...
	@Test
	public void testVDL_4(){
		String mutantName = "VDL_4";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.VDL_4.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.VDL_4.AirlinesBaggageBillingService();
