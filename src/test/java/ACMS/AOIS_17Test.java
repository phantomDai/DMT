...
public class AOIS_17Test extends TestCase{
	...
	@Test
	public void testAOIS_17(){
		String mutantName = "AOIS_17";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_17.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_17.AirlinesBaggageBillingService();
