...
public class AOIS_19Test extends TestCase{
	...
	@Test
	public void testAOIS_19(){
		String mutantName = "AOIS_19";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_19.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_19.AirlinesBaggageBillingService();
