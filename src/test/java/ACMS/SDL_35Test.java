...
public class SDL_35Test extends TestCase{
	...
	@Test
	public void testSDL_35(){
		String mutantName = "SDL_35";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_35.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_35.AirlinesBaggageBillingService();
