...
public class ROR_2Test extends TestCase{
	...
	@Test
	public void testROR_2(){
		String mutantName = "ROR_2";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.ROR_2.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.ROR_2.AirlinesBaggageBillingService();
