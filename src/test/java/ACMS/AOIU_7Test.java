...
public class AOIU_7Test extends TestCase{
	...
	@Test
	public void testAOIU_7(){
		String mutantName = "AOIU_7";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_7.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_7.AirlinesBaggageBillingService();
