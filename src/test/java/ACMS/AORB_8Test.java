...
public class AORB_8Test extends TestCase{
	...
	@Test
	public void testAORB_8(){
		String mutantName = "AORB_8";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_8.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_8.AirlinesBaggageBillingService();
