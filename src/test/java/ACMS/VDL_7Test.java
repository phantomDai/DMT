...
public class VDL_7Test extends TestCase{
	...
	@Test
	public void testVDL_7(){
		String mutantName = "VDL_7";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.VDL_7.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.VDL_7.AirlinesBaggageBillingService();
