...
public class ROR_12Test extends TestCase{
	...
	@Test
	public void testROR_12(){
		String mutantName = "ROR_12";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.ROR_12.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.ROR_12.AirlinesBaggageBillingService();
