...
public class AOIU_9Test extends TestCase{
	...
	@Test
	public void testAOIU_9(){
		String mutantName = "AOIU_9";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_9.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_9.AirlinesBaggageBillingService();
