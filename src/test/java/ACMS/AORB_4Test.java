...
public class AORB_4Test extends TestCase{
	...
	@Test
	public void testAORB_4(){
		String mutantName = "AORB_4";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_4.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_4.AirlinesBaggageBillingService();
