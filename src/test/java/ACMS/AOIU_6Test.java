...
public class AOIU_6Test extends TestCase{
	...
	@Test
	public void testAOIU_6(){
		String mutantName = "AOIU_6";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_6.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_6.AirlinesBaggageBillingService();
