...
public class AOIS_49Test extends TestCase{
	...
	@Test
	public void testAOIS_49(){
		String mutantName = "AOIS_49";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_49.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_49.AirlinesBaggageBillingService();
