...
public class VDL_3Test extends TestCase{
	...
	@Test
	public void testVDL_3(){
		String mutantName = "VDL_3";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.VDL_3.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.VDL_3.AirlinesBaggageBillingService();
