...
public class AOIS_10Test extends TestCase{
	...
	@Test
	public void testAOIS_10(){
		String mutantName = "AOIS_10";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_10.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_10.AirlinesBaggageBillingService();
