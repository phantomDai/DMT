...
public class AOIS_44Test extends TestCase{
	...
	@Test
	public void testAOIS_44(){
		String mutantName = "AOIS_44";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_44.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_44.AirlinesBaggageBillingService();
