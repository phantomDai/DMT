...
public class SDL_39Test extends TestCase{
	...
	@Test
	public void testSDL_39(){
		String mutantName = "SDL_39";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_39.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_39.AirlinesBaggageBillingService();
