...
public class AOIS_22Test extends TestCase{
	...
	@Test
	public void testAOIS_22(){
		String mutantName = "AOIS_22";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_22.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_22.AirlinesBaggageBillingService();
