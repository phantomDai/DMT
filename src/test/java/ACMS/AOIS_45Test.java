...
public class AOIS_45Test extends TestCase{
	...
	@Test
	public void testAOIS_45(){
		String mutantName = "AOIS_45";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_45.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_45.AirlinesBaggageBillingService();
