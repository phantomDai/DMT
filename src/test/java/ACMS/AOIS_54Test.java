...
public class AOIS_54Test extends TestCase{
	...
	@Test
	public void testAOIS_54(){
		String mutantName = "AOIS_54";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_54.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_54.AirlinesBaggageBillingService();
