...
public class AOIS_11Test extends TestCase{
	...
	@Test
	public void testAOIS_11(){
		String mutantName = "AOIS_11";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_11.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_11.AirlinesBaggageBillingService();
