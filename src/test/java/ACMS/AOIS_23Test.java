...
public class AOIS_23Test extends TestCase{
	...
	@Test
	public void testAOIS_23(){
		String mutantName = "AOIS_23";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_23.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_23.AirlinesBaggageBillingService();
