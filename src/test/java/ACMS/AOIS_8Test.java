...
public class AOIS_8Test extends TestCase{
	...
	@Test
	public void testAOIS_8(){
		String mutantName = "AOIS_8";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_8.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_8.AirlinesBaggageBillingService();
