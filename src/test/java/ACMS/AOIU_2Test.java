...
public class AOIU_2Test extends TestCase{
	...
	@Test
	public void testAOIU_2(){
		String mutantName = "AOIU_2";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_2.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_2.AirlinesBaggageBillingService();
