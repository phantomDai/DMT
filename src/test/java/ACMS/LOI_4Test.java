...
public class LOI_4Test extends TestCase{
	...
	@Test
	public void testLOI_4(){
		String mutantName = "LOI_4";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_4.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_4.AirlinesBaggageBillingService();
