...
public class AOIS_42Test extends TestCase{
	...
	@Test
	public void testAOIS_42(){
		String mutantName = "AOIS_42";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_42.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_42.AirlinesBaggageBillingService();
