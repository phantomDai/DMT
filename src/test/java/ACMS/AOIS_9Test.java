...
public class AOIS_9Test extends TestCase{
	...
	@Test
	public void testAOIS_9(){
		String mutantName = "AOIS_9";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_9.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_9.AirlinesBaggageBillingService();
