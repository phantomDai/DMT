...
public class AORB_20Test extends TestCase{
	...
	@Test
	public void testAORB_20(){
		String mutantName = "AORB_20";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_20.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_20.AirlinesBaggageBillingService();
