...
public class AORB_10Test extends TestCase{
	...
	@Test
	public void testAORB_10(){
		String mutantName = "AORB_10";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_10.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_10.AirlinesBaggageBillingService();
