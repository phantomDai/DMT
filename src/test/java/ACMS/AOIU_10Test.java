...
public class AOIU_10Test extends TestCase{
	...
	@Test
	public void testAOIU_10(){
		String mutantName = "AOIU_10";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_10.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_10.AirlinesBaggageBillingService();
