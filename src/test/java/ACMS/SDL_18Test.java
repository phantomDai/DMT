...
public class SDL_18Test extends TestCase{
	...
	@Test
	public void testSDL_18(){
		String mutantName = "SDL_18";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_18.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_18.AirlinesBaggageBillingService();
