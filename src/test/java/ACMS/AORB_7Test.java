...
public class AORB_7Test extends TestCase{
	...
	@Test
	public void testAORB_7(){
		String mutantName = "AORB_7";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_7.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_7.AirlinesBaggageBillingService();
