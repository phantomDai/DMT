...
public class AORB_5Test extends TestCase{
	...
	@Test
	public void testAORB_5(){
		String mutantName = "AORB_5";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_5.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_5.AirlinesBaggageBillingService();
