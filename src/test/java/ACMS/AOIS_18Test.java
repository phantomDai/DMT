...
public class AOIS_18Test extends TestCase{
	...
	@Test
	public void testAOIS_18(){
		String mutantName = "AOIS_18";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_18.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_18.AirlinesBaggageBillingService();
