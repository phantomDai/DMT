...
public class SDL_7Test extends TestCase{
	...
	@Test
	public void testSDL_7(){
		String mutantName = "SDL_7";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_7.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_7.AirlinesBaggageBillingService();
