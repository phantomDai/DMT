...
public class AOIS_20Test extends TestCase{
	...
	@Test
	public void testAOIS_20(){
		String mutantName = "AOIS_20";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_20.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_20.AirlinesBaggageBillingService();
