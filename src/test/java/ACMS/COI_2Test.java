...
public class COI_2Test extends TestCase{
	...
	@Test
	public void testCOI_2(){
		String mutantName = "COI_2";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.COI_2.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.COI_2.AirlinesBaggageBillingService();
