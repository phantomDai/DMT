...
public class AOIS_30Test extends TestCase{
	...
	@Test
	public void testAOIS_30(){
		String mutantName = "AOIS_30";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_30.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_30.AirlinesBaggageBillingService();
