...
public class SDL_4Test extends TestCase{
	...
	@Test
	public void testSDL_4(){
		String mutantName = "SDL_4";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_4.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_4.AirlinesBaggageBillingService();
