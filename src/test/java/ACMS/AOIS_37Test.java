...
public class AOIS_37Test extends TestCase{
	...
	@Test
	public void testAOIS_37(){
		String mutantName = "AOIS_37";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_37.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_37.AirlinesBaggageBillingService();
