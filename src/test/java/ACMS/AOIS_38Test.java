...
public class AOIS_38Test extends TestCase{
	...
	@Test
	public void testAOIS_38(){
		String mutantName = "AOIS_38";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_38.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_38.AirlinesBaggageBillingService();
