...
public class LOI_3Test extends TestCase{
	...
	@Test
	public void testLOI_3(){
		String mutantName = "LOI_3";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_3.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_3.AirlinesBaggageBillingService();
