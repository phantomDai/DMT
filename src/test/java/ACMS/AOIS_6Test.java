...
public class AOIS_6Test extends TestCase{
	...
	@Test
	public void testAOIS_6(){
		String mutantName = "AOIS_6";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_6.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_6.AirlinesBaggageBillingService();
