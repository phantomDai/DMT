...
public class AOIS_12Test extends TestCase{
	...
	@Test
	public void testAOIS_12(){
		String mutantName = "AOIS_12";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_12.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_12.AirlinesBaggageBillingService();
