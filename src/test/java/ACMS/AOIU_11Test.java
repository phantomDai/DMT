...
public class AOIU_11Test extends TestCase{
	...
	@Test
	public void testAOIU_11(){
		String mutantName = "AOIU_11";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_11.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_11.AirlinesBaggageBillingService();
