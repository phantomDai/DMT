...
public class AORB_12Test extends TestCase{
	...
	@Test
	public void testAORB_12(){
		String mutantName = "AORB_12";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_12.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_12.AirlinesBaggageBillingService();
