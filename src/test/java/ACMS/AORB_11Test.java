...
public class AORB_11Test extends TestCase{
	...
	@Test
	public void testAORB_11(){
		String mutantName = "AORB_11";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_11.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_11.AirlinesBaggageBillingService();
