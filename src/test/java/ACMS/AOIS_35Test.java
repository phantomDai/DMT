...
public class AOIS_35Test extends TestCase{
	...
	@Test
	public void testAOIS_35(){
		String mutantName = "AOIS_35";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_35.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_35.AirlinesBaggageBillingService();
