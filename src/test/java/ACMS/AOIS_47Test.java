...
public class AOIS_47Test extends TestCase{
	...
	@Test
	public void testAOIS_47(){
		String mutantName = "AOIS_47";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_47.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_47.AirlinesBaggageBillingService();
