...
public class LOI_2Test extends TestCase{
	...
	@Test
	public void testLOI_2(){
		String mutantName = "LOI_2";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_2.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_2.AirlinesBaggageBillingService();
