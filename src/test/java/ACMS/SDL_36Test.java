...
public class SDL_36Test extends TestCase{
	...
	@Test
	public void testSDL_36(){
		String mutantName = "SDL_36";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_36.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_36.AirlinesBaggageBillingService();
