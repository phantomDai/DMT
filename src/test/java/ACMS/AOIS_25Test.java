...
public class AOIS_25Test extends TestCase{
	...
	@Test
	public void testAOIS_25(){
		String mutantName = "AOIS_25";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_25.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_25.AirlinesBaggageBillingService();
