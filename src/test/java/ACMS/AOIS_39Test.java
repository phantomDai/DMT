...
public class AOIS_39Test extends TestCase{
	...
	@Test
	public void testAOIS_39(){
		String mutantName = "AOIS_39";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_39.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_39.AirlinesBaggageBillingService();
