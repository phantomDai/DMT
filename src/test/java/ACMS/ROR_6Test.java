...
public class ROR_6Test extends TestCase{
	...
	@Test
	public void testROR_6(){
		String mutantName = "ROR_6";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.ROR_6.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.ROR_6.AirlinesBaggageBillingService();
