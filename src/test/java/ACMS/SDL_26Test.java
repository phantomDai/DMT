...
public class SDL_26Test extends TestCase{
	...
	@Test
	public void testSDL_26(){
		String mutantName = "SDL_26";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.SDL_26.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.SDL_26.AirlinesBaggageBillingService();
