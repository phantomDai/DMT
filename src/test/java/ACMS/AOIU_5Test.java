...
public class AOIU_5Test extends TestCase{
	...
	@Test
	public void testAOIU_5(){
		String mutantName = "AOIU_5";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIU_5.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIU_5.AirlinesBaggageBillingService();
