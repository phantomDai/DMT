...
public class AOIS_5Test extends TestCase{
	...
	@Test
	public void testAOIS_5(){
		String mutantName = "AOIS_5";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_5.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_5.AirlinesBaggageBillingService();
