...
public class AOIS_40Test extends TestCase{
	...
	@Test
	public void testAOIS_40(){
		String mutantName = "AOIS_40";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_40.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_40.AirlinesBaggageBillingService();
