...
public class AOIS_2Test extends TestCase{
	...
	@Test
	public void testAOIS_2(){
		String mutantName = "AOIS_2";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AOIS_2.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AOIS_2.AirlinesBaggageBillingService();
