...
public class ROR_7Test extends TestCase{
	...
	@Test
	public void testROR_7(){
		String mutantName = "ROR_7";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.ROR_7.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.ROR_7.AirlinesBaggageBillingService();
