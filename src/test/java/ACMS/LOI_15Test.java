...
public class LOI_15Test extends TestCase{
	...
	@Test
	public void testLOI_15(){
		String mutantName = "LOI_15";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.LOI_15.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.LOI_15.AirlinesBaggageBillingService();
