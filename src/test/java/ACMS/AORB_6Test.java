...
public class AORB_6Test extends TestCase{
	...
	@Test
	public void testAORB_6(){
		String mutantName = "AORB_6";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.AORB_6.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.AORB_6.AirlinesBaggageBillingService();
