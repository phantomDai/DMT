...
public class COI_3Test extends TestCase{
	...
	@Test
	public void testCOI_3(){
		String mutantName = "COI_3";
		testcases = new ArrayList<>();
		createTestCases();
		int count = 0;
		for (TestCase4ACMS tc : testcases) {
			...
			labprograms.ACMS.mutants.COI_3.AirlinesBaggageBillingService mutant = new labprograms.ACMS.mutants.COI_3.AirlinesBaggageBillingService();
