...
//        for (int i = 0; i < Constant.repeatNumber; i++) {
//
//            System.out.println("DMT4" + objectName + "使用MAPT+PSMR:" + "执行第"+ String.valueOf(i + 1) + "次测试：" );
//            //初始化测试剖面
//            initializeMAPT(Constant.getPartitionNumber(objectName));
//
//            UsedMutantsSet mutantsSet = new UsedMutantsSet(objectName);
...
//                dmt.MAPTwithRandomlySelectMR(name);
////                dmt.RAPTwithRandomlySelectMR(name);
////                dmt.MAPTwithPSMRSelectMR(name);
////                dmt.RAPTwithPSMRSelectMR(name);
//            }
//        }
//
//    }
